...
from ..model_phi35 import Phi3DecoderLayer, Phi3ForCausalLM, Phi3RMSNorm


class Phi35LayerAdapter(LayerAdapter):
...
class Phi35ModelAdapter(ModelAdapter):
    ...
    def seqlen(self) -> int:
        ...
        return self.config.original_max_position_embeddings
    ...
    def _from_pretrained(
        ...
        *,
        ...
        if not model_name.startswith("Phi-3.5-mini-instruct"):
            return None
        ...
        return Phi35ModelAdapter(model)
