...
from slicegpt.adapters.llama_adapter import CompressedLlamaDecoderLayer
...
class SlicedLlama(LlamaModel):
    def __init__(self, config):
        ...
        self.layers = nn.ModuleList(
            [CompressedLlamaDecoderLayer(config, layer_idx, replace_layernorm=True) for layer_idx in range(config.num_hidden_layers)]
        )
